...
app.use('/api/public', public_routes_1.default); // Routes publiques pour le site web
...
if (process.env.NODE_ENV !== 'test') {
    ...
    📚 Routes disponibles:
       ...
       → POST   /api/receipts (massothérapeute - créer reçu)
       → GET    /api/receipts (massothérapeute - liste reçus)
    `);
